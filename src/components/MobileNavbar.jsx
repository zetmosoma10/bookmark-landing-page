...
const MobileNavbar = () => {
  return (
    <div className="bg-dark_Blue bg-opacity-95 md:hidden  text-slate-50">
      <nav className="flex flex-col justify-around  h-screen max-container">
        <header>
          <div className="flex items-center justify-between">
            ...
            <img className="cursor-pointer" src={closeIcon} alt="close icon" />
          </div>
          <div className="text-center mt-10 space-y-5">
            ...
            <Button
              type="link"
              className="w-full border leading-4 tracking-[2.31px] text-xl
               border-slate-50 hover:bg-slate-50 hover:text-dark_Blue  duration-100"
            >
              Login
            </Button>
          </div>
